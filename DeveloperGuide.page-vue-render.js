...
with(this){return _c('p',[_v("The "),_c('strong',[_v("API")]),_v(" of this component is specified in "),_c('a',{attrs:{"href":"https://github.com/AY2425S1-CS2103T-F09-1/tp/blob/master/src/main/java/seedu/address/ui/Ui.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Ui.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(" : "),_c('a',{attrs:{"href":"https://github.com/AY2425S1-CS2103T-F09-1/tp/blob/master/src/main/java/seedu/address/logic/Logic.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(" : "),_c('a',{attrs:{"href":"https://github.com/AY2425S1-CS2103T-F09-1/tp/blob/master/src/main/java/seedu/address/model/Model.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(" : "),_c('a',{attrs:{"href":"https://github.com/AY2425S1-CS2103T-F09-1/tp/blob/master/src/main/java/seedu/address/storage/Storage.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Storage.java")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('strong',[_v("Allow events with duplicate names to be added")]),_v(": The current "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add_event")]),_v(" command is too restrictive as it only allows events of unique names to be added to ClubConnect's event list. However, we understand that our users often have recurring events, and such a restriction on the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add_event")]),_v(" command would ruin their user experience. We plan to allow events of the same name but non-overlapping duration window in the future, i.e. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Orbital Workshop from 1 Oct 2024 to 7 Oct 2024")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Orbital Workshop from 10 Oct 2024 to 14 Oct 2024")]),_v(" can co-exist in ClubConnect's event list.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Tech-savvy leaders who organize events, manage activities, and foster community engagement.")]),_v(" "),_c('li',[_v("Connect members, sponsors, and industry partners, driving innovation and learning.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(": Streamline computing club's communication and organization with our address book app. Effortlessly manage member details, sponsor contacts, and event participants in one place. Enhance collaboration, boost engagement, and ensure seamless planning, all while saving time and reducing administrative hassle.")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("Priorities: High (must have) - "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")]),_v(", Medium (nice to have) - "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")]),_v(", Low (unlikely to have) - "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")]),_v(", Exists - "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EXISTS")]),_v(", Not possible - "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("N.A.")])])}
},function anonymous(
) {
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("Committee president")]),_v(" "),_c('td',[_v("Search contacts by multiple criteria (e.g., job title, tags)")]),_v(" "),_c('td',[_v("Find the right contacts even if I don’t remember their names")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("Committee president")]),_v(" "),_c('td',[_v("Filter the contacts to different types of events")]),_v(" "),_c('td',[_v("Easily know who to contact for specific purposes, even with multiple ongoing events")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("Committee member")]),_v(" "),_c('td',[_v("Detect and merge duplicate contacts easily")]),_v(" "),_c('td',[_v("Keep my address book clean and well-organized")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("Committee president")]),_v(" "),_c('td',[_v("Mass delete contacts")]),_v(" "),_c('td',[_v("Easily remove all contacts related to one event after it's over")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Committee president")]),_v(" "),_c('td',[_v("Assign tasks and responsibilities to committee members")]),_v(" "),_c('td',[_v("Ensure all activities are covered without confusion")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Committee member")]),_v(" "),_c('td',[_v("Receive notifications for upcoming meetings and events")]),_v(" "),_c('td',[_v("Stay informed and participate on time")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Events coordinator")]),_v(" "),_c('td',[_v("Send out event reminders and notifications to members")]),_v(" "),_c('td',[_v("Keep everyone informed and boost engagement")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Committee member")]),_v(" "),_c('td',[_v("Import contacts from a CSV file")]),_v(" "),_c('td',[_v("Quickly populate the address book")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Committee member")]),_v(" "),_c('td',[_v("Export contacts to a CSV file")]),_v(" "),_c('td',[_v("Share the contact list with others")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Committee member")]),_v(" "),_c('td',[_v("Customize the app's interface")]),_v(" "),_c('td',[_v("Tailor the app to my preferences")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Club member")]),_v(" "),_c('td',[_v("View a list of upcoming events")]),_v(" "),_c('td',[_v("Stay informed about club activities")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Committee member")]),_v(" "),_c('td',[_v("Add a new event to the calendar")]),_v(" "),_c('td',[_v("Plan club activities")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Committee president")]),_v(" "),_c('td',[_v("Have a blacklist of participants")]),_v(" "),_c('td',[_v("Keep track of people who are not allowed to join future events")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Committee member")]),_v(" "),_c('td',[_v("Track event attendance")]),_v(" "),_c('td',[_v("See who participated")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Secretary")]),_v(" "),_c('td',[_v("Track meeting attendance")]),_v(" "),_c('td',[_v("Maintain records of who participated in club activities")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Committee member")]),_v(" "),_c('td',[_v("View a member's participation history")]),_v(" "),_c('td',[_v("Recognize active members")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EXISTS")])]),_v(" "),_c('td',[_v("Committee member organizing events")]),_v(" "),_c('td',[_v("Label each of my contacts")]),_v(" "),_c('td',[_v("I can easily mass contact sponsors / participants / organizing committee, etc")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EXISTS")])]),_v(" "),_c('td',[_v("Committee member")]),_v(" "),_c('td',[_v("Add a new member to the address book")]),_v(" "),_c('td',[_v("Keep track of all members in the club")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EXISTS")])]),_v(" "),_c('td',[_v("Committee president")]),_v(" "),_c('td',[_v("Delete contacts")]),_v(" "),_c('td',[_v("Avoid contacting people no longer involved with the committee")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("EXISTS")])]),_v(" "),_c('td',[_v("Committee president")]),_v(" "),_c('td',[_v("Keep track of every member’s contact information, e.g., phone number, email address")]),_v(" "),_c('td',[_v("Contact them during an emergency")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("N.A.")])]),_v(" "),_c('td',[_v("Committee member")]),_v(" "),_c('td',[_v("Password-protect sensitive contact information")]),_v(" "),_c('td',[_v("Ensure my contacts remain private and secure")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("N.A.")])]),_v(" "),_c('td',[_v("Communication committee member")]),_v(" "),_c('td',[_v("Log all interactions with sponsors and partners")]),_v(" "),_c('td',[_v("Reference past conversations and ensure nothing is overlooked")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("N.A.")])]),_v(" "),_c('td',[_v("Committee member")]),_v(" "),_c('td',[_v("Send a group email to all members")]),_v(" "),_c('td',[_v("Communicate important information quickly")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("N.A.")])]),_v(" "),_c('td',[_v("Committee member")]),_v(" "),_c('td',[_v("Set reminders for upcoming events")]),_v(" "),_c('td',[_v("Ensure I don’t miss important activities")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("N.A.")])]),_v(" "),_c('td',[_v("Committee member")]),_v(" "),_c('td',[_v("Integrate the app with my calendar")]),_v(" "),_c('td',[_v("Automatically sync important events and reminders")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Use case: UC02 - Edit contact")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS:")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use case: UC03 - Delete contact by index")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS:")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use case: UC04 - Delete contact by name")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS:")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use case: UC05 - Search for contact by criteria")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS:")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use case: UC06 - Label a contact")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS:")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use case: UC07 - Mass Delete")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS:")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use case: UC08 - Filter content by type")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS:")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use case: UC09 - Add event")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS:")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User requests to add an event by providing an event name, event description, event start date, and event end date.")]),_v(" "),_c('li',[_v("App adds the event."),_c('br'),_v("\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("1a. The given event name is invalid (i.e., name is empty or does not start with an alphabet).\n"),_c('ul',[_c('li',[_v("1a1. App shows an error message to tell the user that the given name is invalid."),_c('br'),_v("\nUse case ends.")])])]),_v(" "),_c('li',[_v("1b. The given event description is invalid (i.e., description is empty or consists of only whitespaces).\n"),_c('ul',[_c('li',[_v("1b1. App shows an error message to tell the user that the given description is invalid."),_c('br'),_v("\nUse case ends.")])])]),_v(" "),_c('li',[_v("1c. The given event duration is invalid (i.e., dates are not in the correct format "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("YYYY-MM-DD")]),_v(" or dates are not valid, e.g. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("30 Feb 2024")]),_v(" or event end date is earlier than the start date).\n"),_c('ul',[_c('li',[_v("1c1. App shows an error message to tell the user that the given event dates are not valid."),_c('br'),_v("\nUse case ends.")])])]),_v(" "),_c('li',[_v("1d. The given event has the same name as another event in the list.\n"),_c('ul',[_c('li',[_v("1d1. App shows an error message to tell the user that the event already exists in the list."),_c('br'),_v("\nUse case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC10 - Unassign event from person")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS:")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User requests to unassign an event from a person by providing an event name or an event index, and a person name or a person index.")]),_v(" "),_c('li',[_v("App unassigns the event specified from the person specified."),_c('br'),_v("\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("1a. The given event name does not match any of the existing events.\n"),_c('ul',[_c('li',[_v("1a1. App shows an error message to tell the user that the given event name does not exist."),_c('br'),_v("\nUse case ends.")])])]),_v(" "),_c('li',[_v("1b. The given event index does not exist, i.e. there are only 3 events in the displayed list, but the user inputs an index of 4.\n"),_c('ul',[_c('li',[_v("1b1. App shows an error message to tell the user that the given event index is invalid."),_c('br'),_v("\nUse case ends.")])])]),_v(" "),_c('li',[_v("1c. The given person name does not match any of the existing persons.\n"),_c('ul',[_c('li',[_v("1c1. App shows an error message to tell the user that the given person name does not exist."),_c('br'),_v("\nUse case ends.")])])]),_v(" "),_c('li',[_v("1d. The given person index does not exist, i.e. there are only 3 persons in the displayed list, but the user inputs an index of 4.\n"),_c('ul',[_c('li',[_v("1d1. App shows an error message to tell the user that the given person index is invalid."),_c('br'),_v("\nUse case ends.")])])]),_v(" "),_c('li',[_v("1e. The given person was not previously assigned to the given event.\n"),_c('ul',[_c('li',[_v("1e1. App shows an error message to tell the user that the given person is not assigned to the given event."),_c('br'),_v("\nUse case ends.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("17")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("Should be able to hold up to 1000 persons without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_v("System should respond within two seconds.")]),_v(" "),_c('li',[_v("System should be usable by a novice who has not used a command line interface before.")]),_v(" "),_c('li',[_v("Final product should be a result of evolving/enhancing/morphing the given codebase.")]),_v(" "),_c('li',[_v("Should be for a single user i.e. (not a multi-user product).")]),_v(" "),_c('li',[_v("Needs to be developed in a breadth-first incremental manner over the project duration.")]),_v(" "),_c('li',[_v("Should be stored locally and should be in a human editable text file.")]),_v(" "),_c('li',[_v("Should follow the Object-oriented paradigm primarily.")]),_v(" "),_c('li',[_v("Software should work without requiring an installer.")]),_v(" "),_c('li',[_v("Software should not depend on a remote server.")]),_v(" "),_c('li',[_v("The GUI should work well (i.e., should not cause any resolution-related inconveniences to the user) for,\n"),_c('ul',[_c('li',[_v("standard screen resolutions 1920x1080 and higher, and,")]),_v(" "),_c('li',[_v("for screen scales 100% and 125%.")])])]),_v(" "),_c('li',[_v("In addition, the GUI should be usable (i.e., all functions can be used even if the user experience is not optimal) for,\n"),_c('ul',[_c('li',[_v("resolutions 1280x720 and higher, and,")]),_v(" "),_c('li',[_v("for screen scales 150%.")])])]),_v(" "),_c('li',[_v("JAR / ZIP file should not exceed 100MB.")]),_v(" "),_c('li',[_v("Documents, such as PDF Files, should not exceed 15MB/file.")]),_v(" "),_c('li',[_v("DG and UG should be PDF-friendly. Don't use expandable panels, embedded videos, animated GIFs etc.")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Sun, 10 Nov 2024, 21:19:40 GMT+8]")])])])}
}];
